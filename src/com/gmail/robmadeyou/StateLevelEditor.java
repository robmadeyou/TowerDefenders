...
public class StateLevelEditor {
    ...
    private static void checkTopMenu(){
    	if(selectedTexPack == 0){
    		...
    		menuGrids.setAt(0, TileType.QUICK_TILE_EMPTY, "x");
    		menuGrids.setAt(1, TileType.QUICK_TILE_EMPTY, "x");
    		menuGrids.setAt(2, TileType.QUICK_TILE_EMPTY, "x");
    		menuGrids.setAt(3, TileType.QUICK_TILE_EMPTY, "x");
